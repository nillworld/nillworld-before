...
<title>codeomni.tistory.com bootstrap navigationbar navbar 부트스트랩
	네비게이션바 네비바 소스 코드</title>
		...
		<nav class="navbar navbar-inverse" role="navigation">
			<div class="navbar-header">
				<button type="button" class="navbar-toggle" data-toggle="collapse"
					...
					<span class="sr-only">2122Toggle navigation</span> <span
						class="icon-bar"></span> <span class="icon-bar"></span> <span
						class="icon-bar"></span>
				</button>
				<a href="#" class="navbar-brand easysLogo">c222odeomni</a>
			</div>
